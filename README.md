...
# Debian / Ubuntu
curl -LO https://github.com/atayozcan/sentinel/releases/latest/download/sentinel_0.4.1-1_amd64.deb
sudo apt install ./sentinel_0.4.1-1_amd64.deb

# Fedora / openSUSE
curl -LO https://github.com/atayozcan/sentinel/releases/latest/download/sentinel-0.4.1-1.x86_64.rpm
